...
class TestAddTrait(TestBaremetal):
    def setUp(self):
        ...
        self.baremetal_mock.node.add_traits.return_value = (
            baremetal_fakes.TRAITS)
    ...
    def test_baremetal_add_trait(self):
        ...
        verifylist = [('node', 'node_uuid'), ('trait', ['CUSTOM_FOO'])]
    ...
    def test_baremetal_add_traits_multiple(self):
        ...
        self.assertEqual(self.baremetal_mock.node.add_trait.call_args_list,
                         expected_calls)
...
class TestRemoveTrait(TestBaremetal):
    def setUp(self):
        ...
        self.baremetal_mock.node.remove_traits.return_value = (
            baremetal_fakes.TRAITS)
    ...
    def test_baremetal_remove_trait_multiple(self):
        ...
        self.assertEqual(self.baremetal_mock.node.remove_trait.call_args_list,
                         expected_calls)
